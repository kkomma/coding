...
public class LinkListDbanas {
	...
	public LinkListDbanas next; 
	
	public LinkListDbanas(String bookName, int millionsSold){
...
class LinkList{
	...
	public LinkListDbanas firstLink; 
	...
	public void insertFirstLink(String bookName, int millionsSold){
		...
		LinkListDbanas newLink = new LinkListDbanas(bookName, millionsSold);
	...
	public LinkListDbanas removeFirst(){
		
		LinkListDbanas linkReference = firstLink;
	...
	public void display(){
		...
		LinkListDbanas theLink = firstLink;
	...
	public LinkListDbanas find(String bookName){
	...
	public LinkListDbanas removeLink(String bookName){
		
		LinkListDbanas currentLink = firstLink;
		LinkListDbanas previousLink = firstLink;
