package abc.interview.verygoodgraph;

import java.util.ArrayList;
import java.util.HashMap;

//graph example
//https://www.quora.com/How-do-I-implement-a-graph-in-Java-or-in-code-generally
public class Driver {
	...
	public static void main(String[] args) {
		...
		System.out.println("calling dijkstra shortest path::"+Driver.dijkstraShortestPath(graph, "A"));
	}
