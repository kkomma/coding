...
import java.io.*;
import java.util.*;
//https://www.hackerrank.com/challenges/connected-cell-in-a-grid/editorial
...
public class ConnectedCellsInGrid {
    ...
    public ConnectedCellsInGrid(int n, int m, int[][] grid) {
        this.rows = n;
        this.cols = m; 
        this.grid = grid;
    }
    ...
    public static void main(String[] args) {
        ...
        ConnectedCellsInGrid solution = new ConnectedCellsInGrid(n, m, matrix);
