...
public class ToughMergeTwoSortedArrays 
{ 
	...
	{ 
		ToughMergeTwoSortedArrays mergearray = new ToughMergeTwoSortedArrays(); 
		...
		System.out.println("arrToStr:"+Arrays.toString(N));

		/*Move the m elements at the end of mPlusN*/
		mergearray.moveToEnd(mPlusN, m + n); 
		System.out.println("arrToStr:"+Arrays.toString(mPlusN));
