...
public class WordPuzzleIn2D {
    ...
    private Set<String> findPossibleWords(char[][] puzzle, int minimumWordLength) {
        ...
        if(dimension >= minimumWordLength) {
            ...
            System.out.println("princiapl diagonal words");
            System.out.println(possibleWords.toString());
    ...
    public static void main(String args[]) {
    	WordPuzzleIn2D program = new WordPuzzleIn2D();
        char[][] puzzle = { 
                            {'F','Y','Y','H','N','R','D'},
                            {'R','L','J','C','I','N','U'},
                            {'A','A','W','A','A','H','R'},
