...
public class BinaryTreeVerticalOrderTraversal314 {
    public List<List<Integer>> verticalOrder(TreeNode3 root) {
        if (root == null) return new ArrayList<List<Integer>>();
        Map<Integer, List<Integer>> map = new HashMap<>();
        Queue<TreeNode3> q = new LinkedList<>();
        Map<TreeNode3, Integer> vs = new HashMap<>();
        q.offer(root);
        vs.put(root, 0);
        int min = 0;
        while (!q.isEmpty()) {
    ...
    public List<List<Integer>> verticalOrder2(TreeNode3 root) {
        if (root == null) return new ArrayList<List<Integer>>();
        Map<Integer, List<Integer>> map = new HashMap<>();
        Queue<TreeNode3> q = new LinkedList<>();
     ...
     */
    public List<List<Integer>> verticalOrder3(TreeNode3 root) {
    ...
    public void getRange(TreeNode3 root, int[] range, int col) {
        if (root == null) {
            return;
        }
