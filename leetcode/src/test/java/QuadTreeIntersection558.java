...
class Node5 {
	 ...
	 public Node5(boolean _val,boolean _isLeaf,Node5 _topLeft,Node5 _topRight,Node5 _bottomLeft,Node5 _bottomRight) {
	     val = _val;
	     isLeaf = _isLeaf;
	     topLeft = _topLeft;
	     topRight = _topRight;
...
public class QuadTreeIntersection558 {
    ...
    private Node5 getTopLeft(Node5 n) {
        return n.isLeaf ? n : n.topLeft;
    }

    private Node5 getTopRight(Node5 n) {
        return n.isLeaf ? n : n.topRight;
    }

    private Node5 getBottomLeft(Node5 n) {
        return n.isLeaf ? n : n.bottomLeft;
    }

    private Node5 getBottomRight(Node5 n) {
        return n.isLeaf ? n : n.bottomRight;
    }

    private boolean allLeaves(Node5 n) {
    ...
    private boolean allSame(Node5 n) {
    ...
    public Node5 intersect2(Node5 q1, Node5 q2) {
