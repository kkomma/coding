...
public class PathSum112 {
    public boolean hasPathSum(TreeNode3 root, int sum) {
        return sum(root, sum, 0);
    }

    private boolean sum(TreeNode3 root, int sum, int sumForNow) {
        if (root == null) {
            return false;
        }
     ...
     */
     public boolean hasPathSum2(TreeNode3 root, int sum) {
