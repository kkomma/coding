...
public class BoundaryOfBinaryTree545 {
    public List<Integer> boundaryOfBinaryTree(TreeNode3 root) {
    ...
    private void dfsLeft(TreeNode3 root, boolean[] flag, List<Integer> res) {
    ...
    private void dfsRight(TreeNode3 root, boolean[] flag, List<Integer> res) {
        if (root.left == null && root.right == null) {
            res.add(root.val);
            flag[0] = true;
            return;
