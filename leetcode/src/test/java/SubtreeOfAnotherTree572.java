...
public class SubtreeOfAnotherTree572 {
    public boolean isSubtree(TreeNode3 s, TreeNode3 t) {
        if (s == null) return false;
        if (isSame(s, t)) return true;
        return isSubtree(s.left, t) || isSubtree(s.right, t);
    }

    public boolean isSame(TreeNode3 s, TreeNode3 t) {
     ...
     */
    public boolean isSubtree2(TreeNode3 s, TreeNode3 t) {
        String spreorder = generatepreorderString(s); 
        String tpreorder = generatepreorderString(t);
        return spreorder.contains(tpreorder) ;
    }

    public String generatepreorderString(TreeNode3 s){
        StringBuilder sb = new StringBuilder();
        Stack<TreeNode3> stacktree = new Stack();
        stacktree.push(s);
        while(!stacktree.isEmpty()){
           TreeNode3 popelem = stacktree.pop();
           if(popelem==null)
     ...
     */
    public boolean isSubtree3(TreeNode3 s, TreeNode3 t) {
    ...
    private void serialize(TreeNode3 cur, StringBuilder res) {
