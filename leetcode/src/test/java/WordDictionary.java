...
public class WordDictionary {
    ...
    private static void add(Trieee tr, char[] chars, int i) {
    ...
    private static boolean search(Trieee tr, char[] chars, int i) {
...
class Trieee {
    ...
    Map<Character, Trieee> map = new HashMap<>();
    boolean isWord = false;

    public Trieee() {
    }

    public Trieee get(char c) {
        return this.map.get(c);
    }

    public Trieee add(char c) {
        return this.map.computeIfAbsent(c, cc -> new Trieee());
    }
