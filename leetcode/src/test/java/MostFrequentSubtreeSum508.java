...
public class MostFrequentSubtreeSum508 {
    public int[] findFrequentTreeSum(TreeNode3 root) {
    ...
    private Integer helper(TreeNode3 n, Map<Integer, Integer> sums, int[] cache) {
    ...
    public int[] findFrequentTreeSum2(TreeNode3 root) {
    ...
    public int findFrequentTreeSum(TreeNode3 root, Map<Integer, Integer> map) {
