...
public class LongestUnivaluePath687 {
    public int longestUnivaluePath(TreeNode3 root) {
        if (root == null) return 0;
        return helper(root)[1];
    }

    private int[] helper(TreeNode3 root) {
        int[] res = new int[]{0, 0};
     ...
     */
    int ans;
    public int longestUnivaluePath2(TreeNode3 root) {
        ans = 0;
        arrowLength(root);
        return ans;
    }
    public int arrowLength(TreeNode3 node) {
