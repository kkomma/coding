...
public class ClosestBinarySearchTreeValue270 {
    public int closestValue(TreeNode3 root, double target) {
        return closestValue(root, target, null, null);
    }

    private int closestValue(TreeNode3 root, double target, Integer mi, Integer ma) {
        if (root == null) {
    ...
    public int closestValue2(TreeNode3 root, double target) {
        Integer mi = null;
        Integer ma = null;
     ...
     */
    public int closestValue3(TreeNode3 root, double target) {
        int a = root.val;
        TreeNode3 kid = target < a ? root.left : root.right;
     ...
     */
    public int closestValue4(TreeNode3 root, double target) {
        int ret = root.val;   
        while(root != null){
