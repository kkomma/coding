...
public class SerializeAndDeserializeBinaryTree297 {
    class Codec {
        ...
        public TreeNode3 deserialize(String data) {
            ...
            TreeNode3 res = new TreeNode3(Integer.valueOf(nums[0]));
            ...
            while (i < nums.length) {
                int add = 1;
                TreeNode3 parent = q.remove();
                TreeNode3 left = null;
                if (!nums[i].equals("null")) {
                    left = new TreeNode3(Integer.valueOf(nums[i]));
                    q.add(left);
                }
                ...
                if (i+1 < nums.length) {
                    ...
                    if (!nums[i+1].equals("null")) {
                        right = new TreeNode3(Integer.valueOf(nums[i+1]));
                        q.add(right);
                    }
                }
