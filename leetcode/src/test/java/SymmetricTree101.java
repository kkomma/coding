...
public class SymmetricTree101 {
     ...
     */
    public boolean isSymmetric2(TreeNode3 root) {
     ...
     * https://discuss.leetcode.com/topic/5941/recursive-and-non-recursive-solutions-in-java
     */
    public boolean isSymmetric3(TreeNode3 root) {
        return root==null || isSymmetricHelp(root.left, root.right);
    }

    private boolean isSymmetricHelp(TreeNode3 left, TreeNode3 right){
