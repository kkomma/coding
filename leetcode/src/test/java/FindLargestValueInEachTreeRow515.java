...
public class FindLargestValueInEachTreeRow515 {
    public List<Integer> largestValues(TreeNode3 root) {
     ...
     */
    public List<Integer> largestValues2(TreeNode3 root) {
        List<Integer> res = new ArrayList<Integer>();
        helper(root, res, 0);
        return res;
    }

    private void helper(TreeNode3 root, List<Integer> res, int d){
        if (root == null) return;
