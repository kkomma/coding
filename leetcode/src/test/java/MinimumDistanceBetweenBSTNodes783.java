...
public class MinimumDistanceBetweenBSTNodes783 {
    public int minDiffInBST(TreeNode3 root) {        
        int[] res = new int[]{Integer.MAX_VALUE};
        minDiffInBST(root, new LinkedList<>(), res);
        return res[0];
    }

    public void minDiffInBST(TreeNode3 root, LinkedList<Integer> list, int[] res) {
    ...
    public int minDiffInBST2(TreeNode3 root) {        
        int[] res = new int[]{Integer.MAX_VALUE};
    ...
    public void minDiffInBST2(TreeNode3 root, LinkedList<Integer> list, Integer[] pre, int[] res) {
